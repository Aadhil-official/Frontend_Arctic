  ...
  return (
    <>
      ...
      <Grid container>
        ...
        <Grid item lg={9} md={9} sm={9} xs={9} className="column2" sx={{marginBottom:'5px'}}>chamila@arctic.lk/Arctic@sltnet.lk</Grid>
        <Grid item lg={1} md={1} sm={1} xs={1}></Grid>
      </Grid>
      <Grid container>
        <Grid item lg={1} md={1} sm={1} xs={1}></Grid>
      ...
      <Grid container>
        <Grid item lg={1} md={1} sm={1} xs={1}></Grid>
          ...
          <Grid item lg={9} md={9} sm={9} xs={9} className="column2"><Link to="https://www.arctic.lk">www.arctic.lk</Link></Grid>
          <Grid item lg={1} md={1} sm={1} xs={1}></Grid>
