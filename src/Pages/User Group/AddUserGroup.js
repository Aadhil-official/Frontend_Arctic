...
import { FormAddUserGroup } from '../../Components/User Group/index';
    ...
    return (
        <div>
            ...
            <Grid container className="text">
                <Grid item xl={12} lg={12} md={12} xs={12} sm={12} textAlign={'center'}>
                    <ThemeProvider theme={theme}>
                        <Typography variant='h3' sx={{ fontWeight: 'bold' }}>Add New User Group</Typography>
                    </ThemeProvider>
                </Grid>
            </Grid>
            ...
            <Grid container>
                <ThemeProvider theme={theme}>
                    <Grid item xl={12} lg={12} md={12} xs={12} sm={12} textAlign={'center'}>
                        <Typography variant='h6' sx={{ marginTop: '-25px' }}>Enter user group details</Typography>
                    </Grid>
                </ThemeProvider>
            </Grid>
