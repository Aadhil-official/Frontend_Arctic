...
import { FormCustomerView } from '../../Components/Customer';
        ...
        <div>
            ...
            <Grid container spacing={2}>
                <Grid item position='fixed'>
                    <Link to={"/login/welcome/customerList"}>
            ...
            <Grid container>
                <ThemeProvider theme={theme}>
                    <Grid item xl={12} lg={12} md={12} xs={12} sm={12} textAlign={'center'}>
                        <Typography variant='h6' sx={{ marginTop: '-20px' }}>You can view customer details</Typography>
                    </Grid>
                </ThemeProvider>
            </Grid>
            ...
            <Grid container>
                ...
                <Grid item xl={1.5} lg={2.7} md={6} xs={10.5} sm={8} className="box">
                    {loading ? (
                        ...
                        <FormCustomerView customer={customer} />
                    ) : (
